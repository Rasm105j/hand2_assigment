...
namespace myTiles {
    ...
    helpers._registerFactory("tilemap", function(name: string) {
        switch(helpers.stringTrim(name)) {
            case "level1":
            case "level1":return tiles.createTilemap(hex`0a000800030404040404040404050602010101020101010a0601010101010101010a0601010101010101020a0601010201010101010a0601010101010201010a0601020101010101010a07080808080808080809`, img`
2 2 2 2 2 2 2 2 2 2 
2 . . . . . . . . 2 
2 . . . . . . . . 2 
2 . . . . . . . . 2 
